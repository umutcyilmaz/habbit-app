      ...
      <View style={styles.stack}>
        <AppCard style={styles.windowCard}>
          <View style={styles.cardStack}>
            ...
            <AppText tone="secondary">
              Demo activity suggests support between {window.startTime} and {window.endTime}.
            </AppText>
          </View>
        </AppCard>
        ...
        <AppCard>
          <View style={styles.cardStack}>
            ...
            <AppText tone="secondary">
              These controls update demo state only. No blocking or scheduling is connected.
            </AppText>
