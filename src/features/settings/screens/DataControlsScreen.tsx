      ...
      <View style={styles.stack}>
        <AppCard>
          <View style={styles.cardStack}>
            ...
            <AppText tone="secondary">
              Demo check-ins, pause sessions, and protection preferences are kept in memory only.
            </AppText>
          </View>
        </AppCard>
        ...
        <AppCard style={styles.cautionCard}>
          <View style={styles.cardStack}>
            ...
            <AppText tone="secondary">
              Real deletion is not connected yet. This preview does not remove anything.
            </AppText>
