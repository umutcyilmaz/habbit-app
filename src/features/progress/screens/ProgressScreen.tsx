...
import { LowDataStateCard } from "../../../shared/components/states";
...
export function ProgressScreen() {
  ...
  const hasLowData = selectHasLowProgressData(state);
  const canShowInsights = selectCanShowInsights(state);
          ...
          <AppCard style={styles.insightCard}>
            <View style={styles.cardStack}>
              ...
              <AppText tone="secondary">
                A few more check-ins will help this area feel more useful.
              </AppText>
            </View>
          </AppCard>
        )}
