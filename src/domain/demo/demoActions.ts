...
export type DemoAppAction =
  ...
  | {
      ...
      payload: DemoNotificationPreference;
    };
    ...
    case "ADD_PAUSE_SESSION":
      return {
        ...
        exercises: state.exercises.map((exercise) =>
          exercise.exerciseId === "ninety-second-pause"
            ? {
                ...exercise,
                completedCount: exercise.completedCount + 1
              }
            : exercise
        )
      };
